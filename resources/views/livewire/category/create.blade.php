                ...
                <div class="bg-white px-4 pt-5 pb-4 sm:p-6 sm:pb-4">
                  ...
                  <div class="mb-4">
                    ...
                    @if ($this->image && is_object($this->image))
                        <img src="{{ $this->image->temporaryUrl() }}" alt="{{ $this->name }}" class="w-40 h-40 mx-auto my-3">
                    @elseif ($this->image)
                        <img src="{{ asset('storage/' . $this->image) }}" alt="{{ $this->name }}" class="w-40 h-40 mx-auto my-3">
                    @endif
                    <input type="file" class="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline" id="image" wire:model="image" name="image">
                    ...
                    <div class="mb-4">
                        ...
                        <input type="text"
                            ...
                            @error('meta_title') <small class="text-red-500">{{$message}}</small>@enderror
                    </div>
                    <div class="mb-4">
                        ...
                        <input type="text"
                            ...
                            @error('meta_keyword') <small class="text-red-500">{{$message}}</small>@enderror
                    </div>
                    <div class="mb-4">
                        ...
                        <input type="text"
                            ...
                            @error('meta_description') <small class="text-red-500">{{$message}}</small>@enderror
                    </div>
                    <div class="mb-4">
